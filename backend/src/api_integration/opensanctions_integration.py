...
Provides access to global sanctions lists, PEP data, and compliance screening
"""
...
# Test function
async def test_opensanctions_integration():
    """Test OpenSanctions API integration"""
    async with OpenSanctionsIntegration() as api:
        print("Testing OpenSanctions API integration...")
        
        # Test entity search
        search_result = await api.search_entities("Putin", dataset="sanctions", limit=5)
        ...
        print(f"Comprehensive check: {json.dumps(comprehensive_result, indent=2)}")
...
if __name__ == "__main__":
    asyncio.run(test_opensanctions_integration())
